...
public class EmailService {
	...
	// new EmailService().sendEmail("foreverlove0512t@gmail.com",
	// "http://localhsot:8080/JavaWebCart/");
	// }

	// Google應用程式密碼
	// 請參考此篇 https://www.yongxin-design.com/Article/10
	// 請自行產生Google應用程式密碼
	String googleAppPassword = "dzip cglo utte yxab";

	// 寄件者的電子郵件地址
	String from = "foreverlove0512t@gmail.com";
